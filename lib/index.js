...
function lazyWithPreload(factory) {
    const LazyComponent = react_1.lazy(factory);
    var factoryPromise;
    var LoadedComponent;
    const Component = react_1.forwardRef(function LazyWithPreload(props, ref) {
...
function LazyLoadComponent(props) {
    var _a;
    const _b = react_1.useState(false), showLazyLoadComponent = _b[0], setShowLazyLoadComponent = _b[1];
    const _c = react_1.useState(false), hasClick = _c[0], setHasClick = _c[1];
    const lazyLoadElement = react_1.useRef(null);
